...
| Tabla | PK | Semilla |
|---|---|---|
| programa | id | sin filas: la tabla arranca vacía |
...
```bash
curl http://localhost:8074/api/programa        # total: 8
curl -i http://localhost:8074/api/programa/PR999   # → 404
```
...
- [ ] Modelos/Programa.cs (la entidad: 4 propiedades tipadas)
- [ ] Peticiones/ProgramaCrear.cs (todo obligatorio, con [Required])
