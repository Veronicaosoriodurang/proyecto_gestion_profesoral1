"""Prueba de humo del FRONT Blazor — Gestión profesoral.
...
FICHA = {
    ...
    "tipo": "Tipo " + SUFIJO,
    "nivel": "Nivel " + SUFIJO,
    "fechaCreacion": "Fecha de creación " + SUFIJO,
    "fechaCierre": None,
    "numeroCohortes": "Número de cohortes " + SUFIJO,
    "cantGraduados": "Cantidad de graduados " + SUFIJO,
    "fechaActualizacion": "Fecha de actualización " + SUFIJO,
...
c, cuerpo = ver(f"{API}/api/programa?limite=5")
...
# La jerga se busca como TOKEN TÉCNICO, no como palabra suelta: «programa»
...
revisar("  con su menú y su marco intactos",
        "Programas" in texto and "Gestión profesoral" in texto)
...
# ----------------------------------------------------------------------
print()
codigo = api("DELETE", f"/api/programa/{LLAVE}")
...
revisar("  y la API ya no la entrega",
        api("GET", f"/api/programa/{LLAVE}") == 404)
